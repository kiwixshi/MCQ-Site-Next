...
function IndivQDisplay({indexQ, object, teach, updateAnswers}){
    ...
    function createOption(index, options){
        ...
        <div className="flex items-center w-full ps-4 gap-3 border border-gray-200 rounded dark:border-gray-700">
            ...
            <label for="bordered-checkbox-1" className="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{options}</label>
        </div>)
    }
    ...
    // console.log(object);
    return(
        <div className="flex flex-row gap-8 min-w-20 justify-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <h6 className="m-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{object.qName}</h6>  
            <div className="flex flex-col my-7">    
                ...
                <div className="flex flex-col justify-between p-4 gap-4 leading-normal">
