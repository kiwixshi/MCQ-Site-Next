...
function TestDisplay({key, test, onClick, teach}){
    ...
    <div class="p-8 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" key={key}>
        ...
        <div class="p-13">
            ...
            <p class="mb-2 font-normal text-gray-700 dark:text-gray-400"><span className="font-semibold">Time:</span> {test.testTime} minutes</p>
            <p class="mb-2 font-normal text-gray-700 dark:text-gray-400"><span className="font-semibold">Total Questions:</span> {test.testContent.length} questions</p>
            {/* <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"><span className="font-semibold">Marks:</span> {test.testMarks} marks</p>  */}
            <button onClick={handleClick} class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
